...
\item[\checkmark]A suite of tools, called \textit{RoundUp}\footnote{\bibentry{Liberatore}} (deployed by the researchers) has enabled sharing of plain view observations of online CP and associated activities on various networks.
